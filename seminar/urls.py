...
from .views import seminar_create, seminar_delete, seminar_detail, seminar_list, seminar_update, get_students, create_calendar_event
...
urlpatterns = [
    ...
    path('calendarseminar/create/event/<int:calSeminar_id>/', create_calendar_event, name='create_calendar_event'),
    path('event/<int:ev_id>/calendar/seminar/get/students/', get_students, name='get_students'),
]