...
urlpatterns = [
    ...
    #path('calendardissertation/<int:caldissertation_id>/', calendardissertation_detail, name='calendardissertation_detail'),
    #path('calendardissertation/update/<int:caldissertation_id>/', calendardissertation_update, name='calendardissertation_update'),
    #path('calendardissertation/create/', calendardissertation_create, name='calendardissertation_create'),
    #path('calendardissertation/delete/<int:caldissertation_id>/', calendardissertation_delete, name='calendardissertation_delete'),
]